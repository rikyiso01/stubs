...
def dot(a: ArrayLike[C], b: ArrayLike[C2]) -> NDArray[C | C2]: ...
def resize(a: ArrayLike[T], new_shape: int | tuple[int, ...]) -> NDArray[T]: ...
...
def reshape(a: ArrayLike[T], newshape: tuple[int, ...] | int) -> NDArray[T]: ...
