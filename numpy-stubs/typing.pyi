from typing import Generic, TypeVar, Protocol, Any, Type, SupportsAbs
from collections.abc import Iterator, Sequence

DTypeLike = complex | str
...
class NDArray(Generic[_T], _NDArray[_T]):
    ...
    def var(self: NDArray[_V], *, ddof: int = ...) -> _V | float: ...
    def all(self: NDArray[_V]) -> bool: ...
    def any(self: NDArray[_V]) -> bool: ...
    def ravel(self) -> NDArray[_T]: ...
    ...
    def __floordiv__(self: NDArray[_V], other: ArrayLike[_V2], /) -> NDArray[int]: ...
    def __rfloordiv__(self: NDArray[_V], other: ArrayLike[_V2], /) -> NDArray[int]: ...
    ...
    def __abs__(self: _NDArray[SupportsAbs[_V]]) -> NDArray[_V]: ...
    ...
    def __getitem__(
        self,
        key: int
        | tuple[int | slice | ArrayLike[bool] | ArrayLike[int] | None, ...]
        | slice
        | ArrayLike[bool]
        | ArrayLike[int],
        /,
    ...
    @property
    def real(self: NDArray[complex]) -> NDArray[float]: ...
    @property
    def imag(self: NDArray[complex]) -> NDArray[float]: ...
