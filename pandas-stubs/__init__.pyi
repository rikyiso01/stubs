...
class Series[K, V]:
    ...
    @overload
    def reset_index[K2](self, *, name: K2) -> DataFrame[K2 | str, int, V | K]: ...
    def apply[V2](self, func: Callable[[V], V2]) -> Series[K, V2]: ...
    ...
    def __floordiv__[
        I: int, I2: int
    ](self: SeriesLike[K, I], other: SeriesCompatible[K, I2] | I2) -> Series[
        K, int
    ]: ...
    def info(self) -> None: ...
    ...
    def astype[T](self, dtype: Type[T]) -> Series[K, T]: ...
    ...
    def unstack[
        K2
    ](self: SeriesLike[tuple[K, ...], V], fill_value: K2) -> DataFrame[
        K, tuple[K, ...] | K, V | K2
    ]: ...
...
class DataFrame[K, K2, V]:
    ...
    def rename[
        K3
    ](self, *, columns: SeriesCompatible[K, K3]) -> DataFrame[K | K3, K2, V]: ...
    ...
    def astype[T](self, dtype: Type[T]) -> DataFrame[K, K2, T]: ...
...
def concat[
    K, K2, V
](objs: Iterable[DataFrameLike[K, K2, V]]) -> DataFrame[K, K2, V]: ...
@overload
def concat[K, V](objs: Iterable[Series[K, V]]) -> Series[K, V]: ...
def merge[
    K, K2, V
](
...
def to_datetime[K](arg: Series[K, Any]) -> Series[K, datetime]: ...
def cut[
    V, V2
](
    x: ArrayLike[V],
